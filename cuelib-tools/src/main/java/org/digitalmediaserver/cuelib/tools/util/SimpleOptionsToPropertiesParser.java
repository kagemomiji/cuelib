 ...
 */
package org.digitalmediaserver.cuelib.tools.util;
...
public class SimpleOptionsToPropertiesParser {
	 ...
	 * specified properties will be set to the values following the option. The
	 * first property key is special in that it will be set to the option key
	 * that was parsed. This property key may be null.
	 * </p>
	 *
	 * <p>
	 * For instance, suppose that optionKey is "-add" and that propertyKeys is
	 * ["OPERATION", "FIRST", "SECOND"]. In this case, after parsing ["-add",
	 * "1", "5"], the property "OPERATION" will be set to "-add", property
	 * "FIRST" will be set to "1", and property "SECOND" will be set to "5".
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Register an option with the parser. If one of the alternatives for the
	 * option is found, then the specified properties will be set to the values
	 * following the option. The first property key is special in that it will
	 * be set to the option key that was parsed. This property key may be null.
	 * </p>
	 *
	 * <p>
	 * For instance, suppose that optionKeyAlternatives is {"-a", "-add",
	 * "-add-numbers"} and that propertyKeys is {"OPERATION", "FIRST",
	 * "SECOND"}. In this case, after parsing ["-add", "1", "5"], the property
	 * "OPERATION" will be set to "-add", property "FIRST" will be set to "1",
	 * and property "SECOND" will be set to "5".
	 * </p>
	 *
	 * @param optionKeyAlternatives A list of option keys that indicate the same
	 *            option. For instance {"-a", "-add", "-add-numbers"}.
	 * @param propertyKeys The property keys to set when the option is parsed.
	 */
	 ...
	 * </p>
	 *
	 * @param optionKeyAlternatives An array of option keys that indicate the
	 *            same option. For instance ["-a", "-add", "-add-numbers"].
	 * @param propertyKeys The property keys to set when the option is parsed.
	 */
	 ...
	 * @param properties The Properties instance in which the keys will be set
	 *            that were specified when the options were registered.
	 * @return The index of the first option that could not be matched,
	 *         options.length if everything was matched, or -1 if there was a
	 *         problem.
	 */
	 ...
	 * @param properties The Properties instance in which the keys will be set
	 *            that were specified when the options were registered.
	 * @return The index of the first option that could not be matched, endIndex
